...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-100 overflow-x-hidden">
      {/* 카카오톡 플로팅 버튼 - 실제 카톡 앱 아이콘 디자인 */}
      <button
        onClick={() => setShowErrorModal(true)}
        className="fixed bottom-24 right-8 z-50 w-16 h-16 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 hover:shadow-3xl animate-bounce"
        style={{
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center h-full relative">
          ...
          {/* 말풍선 꼬리 */}
          <div 
            className="bg-white w-2 h-2 transform rotate-45 -mt-1 -ml-4"
          />
        </div>
      </button>
      ...
      >
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <h1 className="text-7xl font-bold mb-6 netflix-fade-in animate-on-scroll">
          ...
          <p className="text-3xl text-sky-700 mb-6 font-medium netflix-slide-in animate-on-scroll" style={{ transitionDelay: '0.2s' }}>
            전문 간호사를 위한 최고의 교육 플랫폼
          </p>
          <p className="text-xl text-sky-600 mb-16 leading-relaxed max-w-3xl mx-auto netflix-fade-in animate-on-scroll" style={{ transitionDelay: '0.4s' }}>
            체계적인 커리큘럼과 전문 교수진의 강의로 여러분의 간호 전문성을 한 단계 높여보세요
          </p>
          
          {/* CTA Button - Netflix 스타일 */}
          <div className="mb-16 netflix-zoom-in animate-on-scroll" style={{ transitionDelay: '0.6s' }}>
            <Link 
              href="/main"
              className="inline-block bg-gradient-to-r from-sky-600 to-blue-600 hover:from-sky-700 hover:to-blue-700 text-white font-bold text-2xl px-16 py-5 rounded-full shadow-2xl netflix-button relative"
            >
      ...
      {/* Stats 섹션 - Netflix 카운터 애니메이션 */}
      <section className="py-20 px-4 bg-gradient-to-r from-white/50 via-sky-50/70 to-blue-50/50 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-12 text-center">
            {[
              ...
              <div key={index} className="netflix-zoom-in animate-on-scroll" style={{ transitionDelay: stat.delay }}>
                <div className="text-6xl font-bold gradient-text mb-4 netflix-card">{stat.number}</div>
                <div className="text-xl text-sky-700 font-semibold">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* AI Talk 모달 */}
      {showAiTalk && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-start justify-center p-4 pt-20 z-50">
            ...
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900">AI Talk</h2>
                    <p className="text-gray-600">궁금한 것을 선택해보세요</p>
                  </div>
                </div>
                <button
                  onClick={() => {
            ...
            <div className="p-6">
              {!selectedCategory ? (
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">어떤 주제가 궁금하신가요?</h3>
                  <div className="grid md:grid-cols-2 gap-4">
                    {Object.keys(aiTalkData).map((category) => (
                      <button
                        key={category}
                        onClick={() => setSelectedCategory(category)}
                        className="p-4 bg-gradient-to-r from-sky-50 to-blue-50 hover:from-sky-100 hover:to-blue-100 rounded-xl border border-sky-200 text-left transition-all duration-300 hover:shadow-lg group"
                      >
                        <div className="flex items-center justify-between">
                          <div>
                            <h4 className="font-semibold text-sky-900 group-hover:text-sky-700">{category}</h4>
                          ...
                          <svg className="w-5 h-5 text-sky-500 group-hover:text-sky-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {aiTalkData[selectedCategory as keyof typeof aiTalkData].map((item, index) => (
                      <button
                        key={index}
                        onClick={() => handleQuestionSelect(item.q, item.a)}
                        className="w-full p-4 bg-white hover:bg-sky-50 rounded-xl border border-gray-200 hover:border-sky-300 text-left transition-all duration-300 hover:shadow-md group"
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <p className="font-medium text-gray-900 group-hover:text-sky-700 leading-relaxed">
                              {item.q}
                            </p>
                          </div>
                          <svg className="w-5 h-5 text-gray-400 group-hover:text-sky-500 ml-3 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-center mt-6">
                    <button
                      ...
                      className="bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-white px-6 py-3 rounded-xl font-medium transition-all duration-300 hover:shadow-lg"
                    >
                      다른 질문하기
                    </button>
                  </div>
            ...
            <div className="p-6 border-t border-gray-200 bg-gray-50 rounded-b-2xl">
              <div className="flex items-center justify-between text-sm text-gray-600">
                <div className="flex items-center space-x-2">
                  ...
                  <span>AI가 24시간 도움을 드립니다</span>
                </div>
                <div className="flex items-center space-x-4">
                  <span>더 자세한 상담이 필요하시면</span>
                  <button 
                    onClick={() => setShowErrorModal(true)}
      ...
      {showErrorModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-bold text-gray-900">카카오톡 문의</h3>
              <button
            ...
            <div className="text-center">
              <div className="bg-yellow-50 rounded-xl p-4 mb-4">
                ...
                {/* 카카오톡 문의 안내 */}
                <div className="bg-white rounded-lg p-6 inline-block shadow-md border-2 border-yellow-300">
                  <div className="text-center">
                    <div className="text-6xl mb-4">💬</div>
                    <h4 className="text-lg font-bold text-gray-900 mb-2">카카오톡 상담</h4>
                    <div className="bg-yellow-100 rounded-lg p-3 mb-3">
                      <p className="text-yellow-800 font-semibold text-lg">hyejilee0818</p>
                    </div>
                    <p className="text-sm text-gray-600">
                      카카오톡에서 위 ID를 검색하거나<br/>
                      아래 ID 복사 버튼을 이용해주세요!
                    </p>
                  </div>
                </div>
              ...
              <div className="flex space-x-3">
                ...
                <button
                  onClick={() => {
                    navigator.clipboard.writeText('hyejilee0818').then(() => {
                      alert('카카오톡 ID가 복사되었습니다!');
                    }).catch(() => {
                      alert('복사에 실패했습니다. 다시 시도해주세요.');
                    });
                  }}
                  className="flex-1 bg-yellow-400 text-gray-900 py-3 rounded-lg hover:bg-yellow-500 transition-colors font-medium"
                >
                  ID 복사
                </button>
              </div>
